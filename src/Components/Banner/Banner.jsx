    ...
    <div className=" hero bg-[#1313130D] min-h-screen container mx-auto rounded-xl px-4 sm:px-8 lg:px-12">
        <div className="hero-content flex-col lg:flex-row-reverse">
            ...
            <div className='space-x-20'>
                <h1 className="text-4xl md:text-6xl font-bold mt-10 md:mt-0">Books to freshen up <br /> your bookshelf</h1>
                <button className="btn py-6 font-bold text-xl bg-[#23BE0A] text-white mt-12">
